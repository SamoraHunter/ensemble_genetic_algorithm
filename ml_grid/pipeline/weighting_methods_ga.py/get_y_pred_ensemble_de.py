...
def get_weighted_ensemble_prediction_de_y_pred_valid(best, weights, ml_grid_object, valid=False):
    ...
    #         is evaluate calling model text also fitting?
            if(type(target_ensemble[i][1]) is not torch_binary_classification_method_ga.BinaryClassification):
