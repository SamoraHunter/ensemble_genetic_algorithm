"""Tests for kNearestNeighbors_model module."""
...
class TestKNNEstNeighborsModelGenerator:
    """Tests for the kNearestNeighborsModelGenerator function."""

    def test_knn_basic_functionality(self):
        """Test basic functionality of kNearestNeighborsModelGenerator."""
        ...
        try:
            ...
            result = kNearestNeighborsModelGenerator(pipeline, local_param_dict)
    ...
    def test_knn_with_verbose_logging(self):
    ...
    def test_knn_with_store_base_learners_true(self):
        """Test kNearestNeighborsModelGenerator with store_base_learners=True."""
        from ml_grid.model_classes_ga.kNearestNeighbors_model import (
            kNearestNeighborsModelGenerator,
        )
        from ml_grid.pipeline.data import pipe
    ...
    def test_knn_with_weights_uniform(self):
        """Test kNearestNeighborsModelGenerator with weights='uniform'."""
        from ml_grid.model_classes_ga.kNearestNeighbors_model import (
            kNearestNeighborsModelGenerator,
        )
        from ml_grid.pipeline.data import pipe
    ...
    def test_knn_with_weights_distance(self):
        """Test kNearestNeighborsModelGenerator with weights='distance'."""
        from ml_grid.model_classes_ga.kNearestNeighbors_model import (
            kNearestNeighborsModelGenerator,
        )
        from ml_grid.pipeline.data import pipe
    ...
    def test_knn_returns_correct_tuple_structure(self):
        """Test that kNearestNeighborsModelGenerator returns a valid 6-element tuple."""
        from ml_grid.model_classes_ga.kNearestNeighbors_model import (
            kNearestNeighborsModelGenerator,
        )
        from ml_grid.pipeline.data import pipe
